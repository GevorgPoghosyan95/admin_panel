    ...
    */
    ...
    $.fn.editableform.defaults = {
        ...
        **/
        pk: null,
        /**
        Initial value. If not defined - will be taken from element's type.
    ...
    Popup.prototype = {
        ...
        **/
        ...
        show: function (closeAll) {
            ...
            The main reason is that we dont know, what will container do with type when closed:
        ...
        **/
        ...
        /*
        Updates the position of container when type changed.
        @method setPosition()
        */
    ...
    Editable.prototype = {
        ...
        */
        handleEmpty: function (isEmpty) {
            ...
            It is required when we enable/disable field and can't rely on type
            as node type is text: "Empty" that is not empty %)
            */
...
(function ($) {
    ...
    $.extend($.fn.editableContainer.Popup.prototype, {
        ...
        //for compatibility with bootstrap <= 2.2.1 (type inserted into <p> instead of directly .popover-type)
        innerCss: $.fn.popover && $($.fn.popover.defaults.template).find('p').length ? '.popover-type p' : '.popover-type',
