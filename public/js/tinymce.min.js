!function () {
    ...
    var Sd, Nd, Ed, kd, _d, Ad = (Sd = "height", Nd = function (e) {
        ...
        tm = {
            ...
            return Gd().filter(function (e) {
                return t = e.dom, !((n = t.classList) !== undefined && (n.contains("tox-edit-area") || n.contains("tox-edit-area__iframe") || n.contains("mce-type-body"))) && vm(r, e.dom);
                var t, n
            }).isSome()
        }, Em = function (e) {
    ...
    var ub = function (n) {
        ...
        var e, n,
            ...
            o = t.editorManager.baseURL + "/skins/type", i = "content" + t.editorManager.suffix + ".css",
            a = !0 === t.inline;
    ...
    var JS = function (e) {
        ...
        }), u.contentStyles.push(".mce-type-body {-webkit-touch-callout: none}")) : v()), 11 <= wt.ie && (b(), y()), wt.ie && (v(), g("AutoUrlDetect", !1), u.on("dragstart", function (e) {
            var t, n, r;
        ...
        n.inline || (t.getElement().style.visibility = t.orgVisibility), e || t.inline || (o.open(), o.write(t.iframeHTML), o.close()), t.inline && (hN.addClass(r, "mce-type-body"), t.contentDocument = o = document, t.contentWindow = window, t.bodyElement = r, t.contentAreaContainer = r);
        ...
        e.getParam("document_base_url", "") !== e.documentBaseUrl && (t += '<base href="' + e.documentBaseURI.getURI() + '" />'), t += '<meta http-equiv="Content-Type" type="text/html; charset=UTF-8" />';
        var n = gc(e, "body_id", "tinymce"), r = gc(e, "body_class", "");
        return hc(e) && (t += '<meta http-equiv="Content-Security-Policy" type="' + hc(e) + '" />'), t += '</head><body id="' + n + '" class="mce-type-body ' + r + '" data-id="' + e.id + '"><br></body></html>'
    }, EN = function (e, t) {
    ...
    var nE = "data-mce-contenteditable", rE = function (e, t, n) {
            ...
            rE(i, "mce-type-readonly", t), t ? (e.selection.controlSelection.hideResizeRect(), e._selectionOverrides.hideFakeCaret(), o = e, U.from(o.selection.getNode()).each(function (e) {
                e.removeAttribute("data-mce-selected")
